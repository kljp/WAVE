...
void bfs_bu2(
    ...
    fqg_bu_tcfe<vertex_t, index_t, depth_t> // thread-centric frontier enqueue
    <<<BLKS_NUM_REV_TCFE, THDS_NUM_REV_TCFE>>>(
    ...
    calc_rmnd<vertex_t, index_t, depth_t>
    <<<1, 1>>>(
    ...
    *fq_sz_h = 1;
    ...
    for(level = 0; ; level++){
        ...
        if(!TD_BU){
            ...
            bfs_bu2<vertex_t, index_t, depth_t>(
